...
class DocumentTypesRow extends React.Component {
    constructor(props, context) {
        super(props, context);           
        this.handleConfirmAction = this.handleConfirmAction.bind(this);
    }
    handleEditButton(param){      
        this.props.funcionClick('FormDocumentTypes',param);        
    }
    ...
    handleConfirmAction(id) {        
        ...
        axios.delete('http://localhost:5000/document_types',{            
            data: {id : id},
...
export default DocumentTypesRow
